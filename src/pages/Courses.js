...
const Courses = () => {
  return (
    <div className="container">
      <p className="header-div"> &lt;Courses/&gt;</p>
      <div class="container">
        <div class="profile-wrapper" style={{ animationDelay: `${0 * 0.3}s` }}>
          <div class="profile">
            <div class="profile-image">
              <img src={nodejslogo} alt="Profile" />
            </div>
            <ul class="social-icons">
              <li>
                <a
                  href="https://www.udemy.com/course/the-complete-nodejs-developer-course-2/?kw=The+Complete+Node.js+Developer+Course+%283rd+Edition%29&src=sac"
                  title="UdemyCourse"
                >
                  <svg
                    viewBox="0 0 91 34"
            ...
            <div class="profile-name">
              ...
              <div class="profile-bio">
                ...
                package management, grasped the fundamentals of MongoDB, async
                programming, and learned about essential tools like Socket.io,
                jsonwebtoken, email integration, and application deployment. The
                course effectively covered REST API development as well.
              </div>
            </div>
          </div>
        </div>
        <div class="profile-wrapper" style={{ animationDelay: `${1 * 0.3}s` }}>
          <div class="profile">
            <div class="profile-image">
              <img
                class="profile-image-react"
                src={reactjslogo}
                alt="Profile"
              />
            </div>
            ...
            <div class="profile-name">
              ...
              <div class="profile-bio">
                ...
                improved my knowledge about Git and learned Redux basics.
              </div>
            </div>
          </div>
        </div>
        <div class="profile-wrapper" style={{ animationDelay: `${2 * 0.3}s` }}>
          <div class="profile">
            <div class="profile-image">
              <img src={mongodblogo} alt="Profile" />
            </div>
            <ul class="social-icons">
              <li>
                <a
            ...
            <div class="profile-name">
              ...
              <div class="profile-bio">
                ...
                relations, and advanced operations like Aggregation. Also course
                covered using tools like MongoDB Compas and similar tools to
                work with MongoDB.
              </div>
            </div>
          </div>
